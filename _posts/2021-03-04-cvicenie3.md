...
Pozrite si názornú ukážku Gauss-Jordanovej metódy [->v tomto súbore<-](http://maslarova.github.io/cvicenie3/priklad_GJ.m). Všimnite si, že pomocou Gauss-Jordanovej metódy sme schopní priamo vypočítať inverznú maticu.
