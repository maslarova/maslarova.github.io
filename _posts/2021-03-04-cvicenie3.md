...
kde $\mathbb{A}$ je regulárna matica typu $n \times n$, $\mathbf{b}$ je vektor pravej strany a \mathbf{x} je riešenie sústavy. Medzi ďalšie základné úlohy patrí hľadanie vlastných čísel a vektorov matice.
