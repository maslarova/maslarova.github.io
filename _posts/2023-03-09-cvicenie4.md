...
-Príklad riešenia sústavy v Matlabe: [->skript<-](http://maslarova.github.io/cvicenie4/iter_metody.m)
-Príklad na riešenie Poissonovej rovnice pomocou tridiagonálnej matice: [->pdf<-](http://maslarova.github.io/cvicenie4/iter_metody.m), [->riešenie matice 3x3 v Matlabe<-](http://maslarova.github.io/cvicenie4/iter_metody.m), [->riešenie pre všebecný počet riadkov n v Matlabe<-](http://maslarova.github.io/cvicenie4/iter_metody.m)
