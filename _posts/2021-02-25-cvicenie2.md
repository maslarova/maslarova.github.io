...
{: .centering}
$f'(x)\sim\frac{f(x+h)-f(x)}{h}\simf'(x)+h\frac{f''(x)}{2!}+h^2\frac{f'''(x)}{3!}$
...
{: .centering}
$\delta x = 1.32483726-1.32483726=5\cross10^{-9}$

Odhad relatívnej chyby potom môžeme vypočítať ako
{: .centering}
$\delta x = 1.32483726-1.32483726=5\cross10^{-9}$

To isté platí pre y, t.j. $A(y) = 5\cross10^{-9}$, $\delta y = 5\cross10^{-9}$. Vykonajme teraz rozdiel 

{: .centering}
$x - y  = 1.32483726 - 1.32483357 = 4 \cross 10^{-6}$
