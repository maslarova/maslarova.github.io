...
Všimnime si, že v rámci jedinej operácie sme prešli z relatívnej presnosti na oveľa nižšiu relatívnu prenosť !
...
Nekonečne krátky časový krok $\mathrm{d}t$ nahraďme konečne krátkym konečným krokom $h$:<br>
...
Prečítajte si [->analytické vysvetlenie<-](kfe.fjfi.cvut.cz/~matysma4/nme/cv02/priklad21.pdf) stability týchto algoritmov. Vidíte, že pri dvojkrokovej metóde chyba rastie s počtom krokov - to je numerická definícia nestability.
...
Na záver si prečítajte aj [->stručný prehľad o numerickej stabilite a výbere numerickej metódy<-](kfe.fjfi.cvut.cz/~matysma4/nme/cv02/cviceni2a.pdf).
<br>
