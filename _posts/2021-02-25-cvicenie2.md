...
{: .centering}
$f'(x)\sim\frac{f(x+h)-f(x)}{h}\sim\frac{f(x)+h\frac{f\prime(x)}{1!}+h^2\frac{f\prime\prime(x)}{2!}+h^3\frac{f\prime\prime\prime(x)}{3!}-f(x)}{h}$

{: .centering}
$f'(x)\sim\frac{f(x+h)-f(x)}{h}\sim f\prime(x)+h\frac{f\prime\prime\prime(x)}{2!}+h^2\frac{f\prime\prime\prime(x)}{3!}$
